...
export const ROLE_PERMISSIONS: Record<SystemRoleKey, PermissionCode[]> = {
  [SYSTEM_ROLES.ADMINISTRATOR]: [
    ...
    P.RESERVATION_VIEW, P.RESERVATION_CREATE, P.RESERVATION_CONFIRM, P.RESERVATION_RELEASE, P.RESERVATION_CANCEL, P.RESERVATION_OVERRIDE,
    P.RETURN_VIEW, P.RETURN_CREATE, P.RETURN_RECEIVE, P.RETURN_INSPECT, P.RETURN_DISPOSE,
    P.INVENTORY_EXPIRY_OVERRIDE, P.INVENTORY_FEFO_OVERRIDE,
    P.CYCLE_COUNT_VIEW, P.CYCLE_COUNT_CLASSIFY, P.CYCLE_COUNT_SCHEDULE, P.CYCLE_COUNT_ASSIGN, P.CYCLE_COUNT_MANAGE_POLICY,
    P.SERIAL_VIEW, P.SERIAL_MANAGE_POLICY,
  ],
  [SYSTEM_ROLES.INVENTORY_MANAGER]: [
    ...
    P.RESERVATION_VIEW, P.RESERVATION_CREATE, P.RESERVATION_CONFIRM, P.RESERVATION_RELEASE, P.RESERVATION_CANCEL,
    P.RETURN_VIEW, P.RETURN_CREATE, P.RETURN_RECEIVE, P.RETURN_INSPECT, P.RETURN_DISPOSE,
    P.INVENTORY_EXPIRY_OVERRIDE, P.INVENTORY_FEFO_OVERRIDE,
    P.CYCLE_COUNT_VIEW, P.CYCLE_COUNT_CLASSIFY, P.CYCLE_COUNT_SCHEDULE, P.CYCLE_COUNT_ASSIGN, P.CYCLE_COUNT_MANAGE_POLICY,
    P.SERIAL_VIEW, P.SERIAL_MANAGE_POLICY,
  ...
  [SYSTEM_ROLES.WAREHOUSE_STAFF]: [
    P.INVENTORY_VIEW, P.INVENTORY_RECEIVE, P.INVENTORY_RELEASE, P.INVENTORY_TRANSFER,
    P.INVENTORY_COUNT,
    P.RESERVATION_VIEW, P.RESERVATION_CREATE, P.RESERVATION_CONFIRM, P.RESERVATION_RELEASE,
    // Staff can intake and inspect/restock, but NOT the destructive dispositions (return.dispose).
    P.RETURN_VIEW, P.RETURN_CREATE, P.RETURN_RECEIVE, P.RETURN_INSPECT,
    // Staff can see and execute cycle-count work (execution uses inventory.count), but not plan it.
    P.CYCLE_COUNT_VIEW,
    // Staff capture serials during receiving (via inventory.receive) and can read the registry.
    P.SERIAL_VIEW,
  ],
  ...
  [SYSTEM_ROLES.AUDITOR]: [
    ...
    P.CYCLE_COUNT_VIEW, P.SERIAL_VIEW,
  ],
  [SYSTEM_ROLES.VIEWER]: [
    P.INVENTORY_VIEW, P.REPORT_VIEW, P.RESERVATION_VIEW, P.RETURN_VIEW, P.CYCLE_COUNT_VIEW, P.SERIAL_VIEW,
  ],
};
