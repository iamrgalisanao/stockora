...
export const ROLE_PERMISSIONS: Record<SystemRoleKey, PermissionCode[]> = {
  [SYSTEM_ROLES.ADMINISTRATOR]: [
    ...
    P.IMPORT_PRODUCTS, P.IMPORT_SUPPLIERS, P.IMPORT_OPENING_INVENTORY, P.EXPORT_CATALOG, P.EXPORT_INVENTORY,
  ],
  [SYSTEM_ROLES.INVENTORY_MANAGER]: [
    ...
    // Catalog/supplier bulk import + exports, but NOT opening-inventory import (admin-restricted).
    P.IMPORT_PRODUCTS, P.IMPORT_SUPPLIERS, P.EXPORT_CATALOG, P.EXPORT_INVENTORY,
  ],
  ...
  [SYSTEM_ROLES.PURCHASING]: [
    ...
    P.IMPORT_SUPPLIERS, P.EXPORT_CATALOG,
  ],
