...
export const ROLE_PERMISSIONS: Record<SystemRoleKey, PermissionCode[]> = {
  [SYSTEM_ROLES.ADMINISTRATOR]: [
    ...
    P.INVENTORY_COUNT, P.INVENTORY_ADJUST, P.INVENTORY_APPROVE_ADJUSTMENT, P.INVENTORY_RESERVE,
    P.OVERRIDE_NEGATIVE, P.COST_VIEW, P.VALUATION_VIEW, P.PRODUCT_MANAGE, P.WAREHOUSE_MANAGE,
    P.SUPPLIER_MANAGE, P.USER_MANAGE, P.ROLE_MANAGE, P.SETTINGS_MANAGE, P.REPORT_VIEW,
    P.REPORT_EXPORT, P.AUDIT_VIEW,
  ],
  [SYSTEM_ROLES.INVENTORY_MANAGER]: [
    P.INVENTORY_VIEW, P.INVENTORY_RECEIVE, P.INVENTORY_RELEASE, P.INVENTORY_TRANSFER,
    P.INVENTORY_COUNT, P.INVENTORY_ADJUST, P.INVENTORY_APPROVE_ADJUSTMENT, P.INVENTORY_RESERVE,
    P.COST_VIEW, P.VALUATION_VIEW, P.PRODUCT_MANAGE, P.WAREHOUSE_MANAGE, P.SUPPLIER_MANAGE,
    P.REPORT_VIEW, P.REPORT_EXPORT, P.AUDIT_VIEW,
  ],
  [SYSTEM_ROLES.WAREHOUSE_MANAGER]: [
    P.INVENTORY_VIEW, P.INVENTORY_RECEIVE, P.INVENTORY_RELEASE, P.INVENTORY_TRANSFER,
    P.INVENTORY_COUNT, P.INVENTORY_ADJUST, P.INVENTORY_APPROVE_ADJUSTMENT, P.INVENTORY_RESERVE,
    P.COST_VIEW, P.WAREHOUSE_MANAGE, P.REPORT_VIEW, P.REPORT_EXPORT,
  ],
  ...
  [SYSTEM_ROLES.FINANCE]: [
    P.INVENTORY_VIEW, P.INVENTORY_APPROVE_ADJUSTMENT, P.COST_VIEW, P.VALUATION_VIEW,
    P.REPORT_VIEW, P.REPORT_EXPORT, P.AUDIT_VIEW,
  ],
  [SYSTEM_ROLES.APPROVER]: [
    P.INVENTORY_VIEW, P.INVENTORY_APPROVE_ADJUSTMENT, P.REPORT_VIEW,
  ],
